...
タッチセンサーのしきい値は環境によって違うので、あらかじめtouchRead()などで試してみて数字を変更してください。

## サンプルスケッチ[[GitHub](https://github.com/tanakamasayuki/M5StickC-examples/blob/master/Sleep/LightSleepTouchWakeUp/LightSleepTouchWakeUp.ino)]
